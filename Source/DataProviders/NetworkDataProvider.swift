...
public class NetworkDataProvider: DataProvider {
    ...
    public func getModules(completionHandler handler: (Halo.Result<PaginatedModules>) -> Void) -> Void {

    }

    public func search(searchQuery: Halo.SearchQuery, completionHandler handler: (Halo.Result<PaginatedContentInstances>) -> Void) -> Void {
